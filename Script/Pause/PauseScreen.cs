...
public class PauseScreen : MonoBehaviour {
    ...
    // メンバ変数
    [SerializeField] private UIWidget[]     pauseGraphicWidgetArray;   // ポーズ中の画像ウィジェット配列
    [SerializeField] private UIWidget[]     pauseMenuWidgetArray;      // ポーズ中のメニューウィジェット配列
 //   [SerializeField] string testname;
    ...
    private GameObject                      playerposition;         //プレイヤーの位置初期化
      ...
      //  if (!Input.GetKeyDown(KeyCode.Return)) { return; }
        ...
        switch ( name ) {
            ...
            case "Pause_Label_Menu_Return":
                ...
                //ステージセレクトを読み込み
              // if (Input.GetKeyDown(KeyCode.Return)) { Application.LoadLevel("StageSelect"); }
...
//				FadeScript.fadeScript.FadeStart( "Title" );
            ...
            case "Pause_Label_Menu_StageSelect":
